...
contract MappingStructExample{
    ...
    function withdrawMoney(address payable _to, uint amount) public{
        //checks if amount is less than the value held by the sender
        require(amount<=balanceRecieved[msg.sender].totalBalance, "you don't have enough funds for carrying out the transaction");
